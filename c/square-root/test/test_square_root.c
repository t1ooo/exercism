...
static void test_root_of_0(void)
{
   TEST_ASSERT_EQUAL_UINT16(0, square_root(0));
}
...
static void test_root_of_5(void)
{
   // TEST_IGNORE();
   TEST_ASSERT_EQUAL_UINT16(2, square_root(5));
}
...
static void test_root_of_564163(void)
{
   // TEST_IGNORE();
   TEST_ASSERT_EQUAL_UINT16(751, square_root(564163));
}
