...
static void print_triplets(char* name, size_t count, triplet_t triplets[]) {
...
static void test_triplets_whose_sum_is_12(void)
{
   ...
   print_triplets("expected", expected_count, expected_triplets);
   print_triplets("actual", triplets->count, triplets->triplets);
...
static void test_no_matching_triplets_for_1001(void)
{
   ...
   print_triplets("expected", expected_count, NULL);
   print_triplets("actual", triplets->count, triplets->triplets);
