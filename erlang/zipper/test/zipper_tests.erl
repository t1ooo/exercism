...
'8_set_value_after_traversiing_up_test'() ->
    Exp  = t2(),
    Act0 = zipper:from_tree(t1()),
    Act1 = zipper:left(Act0),
...
'11_set_right_with_subtree_test'() ->
    Exp  = t5(),
    Act0 = zipper:from_tree(t1()),
...
'12_set_value_from_deep_focus_test'() ->
    Exp  = t6(),
    Act0 = zipper:from_tree(t1()),
    Act1 = zipper:left(Act0),
    Act2 = zipper:right(Act1),
